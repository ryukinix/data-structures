...
Este repositório é onde se encontra as principais notas sobre alguns
conceitos e exercícios propostos em sala de aula da disciplina
Estrutura de Dados, ministrada pelo professor Jarbas Joaci de Sá Jr na
UFC - Sobral, 2017.2.
...
7. [[file:6-arvores.org][Árvores]]
8. [[file:7-arvore-binaria-de-busca.org][Árvore Binária de Busca (BST)]]
...
através da [[https://github.com/ryukinix/data-structures/releases][release]] 0.3.0.
